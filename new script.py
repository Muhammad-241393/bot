...
ADVICE_MIN_INTERVAL  = 140   # 4.5 minutes (270 seconds)
ADVICE_MAX_INTERVAL  = 200   # 5.5 minutes (330 seconds)
...
def get_fallback_analysis() -> str:
    ...
    fallbacks = [
                "Standard flow so far, nothing out of the ordinary unfolding.",
        "Energy feels muted across the tape, just monitoring price action.",
        "Volatility is contracting, pressure building beneath the surface.",
        "Depth is light right now, not much fuel for expansion.",
        "Chop dominating the board, conviction still absent.",
        "Rejections showing up on candles but no continuation yet.",
        "Key areas are holding firm, momentum just hasn’t kicked in.",
        "Market feels paused, like it’s waiting on confirmation.",
        "Framework looks solid, just lacking a spark.",
        "Supply stepped in momentarily but couldn’t press the advantage.",
        "Demand continues to defend critical levels, maintaining balance.",
        "Routine early drift, nothing actionable at the moment.",
        "Flows are evenly matched, edge remains unclear.",
        "Price coiling tighter, expansion likely sooner or later.",
        "Range-bound rotations, classic accumulation behavior.",
        "Anticipating a liquidity sweep before the real setup forms.",
        "Quiet tape today but structure sets up well for next session.",
        "Volume too thin to validate any breakout attempt.",
        "Trend structure holding steady, just consolidating gains.",
        "Narrow range environment, conserving energy for a larger move."
    ]
...
async def get_random_greeting() -> str:
    ...
    messages = [
                "Yo what’s happening",
        "Good afternoon team",
        "These charts are dry today honestly",
        "morning crew",
        "Just got in front of the monitors",
        "Seeing any decent moves anywhere?",
        "Total lull at the moment",
        "Hardly any movement printing",
        "Levels mapped out, now it’s patience",
        "Completely flat session so far",
        "Probably staying sidelined here",
        "My setups just aren’t present today",
        "Rules first, always",
        "Europe dragged, maybe NY brings energy",
        "Considering logging off early",
        "Keeping my finger off the trigger today",
        "Staying liquid is still a stance",
        "No need to press trades in this environment",
        "What’s up everyone",
        "Another coffee down and still slow haha",
        "Hope everyone’s week’s off to a solid start",
        "Price looks heavy to me",
        "Cooling out for the next few hours",
        "Just bouncing between support and resistance",
        "Not seeing strong long confirmations yet",
        "Anyone actually trading this range?",
        "Flat exposure at the moment",
        "Reviewing past trades instead",
        "Market needs to choose a side",
        "Signals are all over the place",
        "Wake me up for a real breakout",
        "Glad I didn’t FOMO earlier",
        "Sometimes sitting out wins",
        "Pretty quiet session huh",
        "Watching how this higher timeframe candle settles",
        "This kind of chop punishes impatience",
        "Either tiny size or none at all today",
        "Mostly just refining my chart markings",
        "Moving at a snail’s pace",
        "We need participation to drive this",
        "This tape is sleepy",
        "Stepping away for a bit, no rush",
        "Stick to the plan no matter what",
        "Letting time do its thing",
        "Market’s in full relax mode",
        "Sideways grind continues",
        "Missed Asia but looks like nothing happened",
        "Opportunities show up eventually, no forcing",
        "Not feeling synced with this price action",
